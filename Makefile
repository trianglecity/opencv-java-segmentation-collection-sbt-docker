...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/opencv/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/opencv/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/opencv/$(BIND_DIR)")
...
UBUNTU_IMAGE := opencv-segmentation-java-dev:01
